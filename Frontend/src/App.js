            ...
            <Layer>
              ...
              {(boxes || []).map((b, i) => (
                <Group key={`user_${i}`}>
                  ...
                  >
                    <Rect width={18} height={18} fill="white" stroke="#2196f3" cornerRadius={6} opacity={0.85} />
                    <KonvaTextLabel x={2} y={2} text="✕" color="#2196f3" size={16} noBg />
                  </Group>
                </Group>
              ))}
              ...
              {(predictionBoxes || []).map((b, i) => (
                <Group key={`pred_${i}`}>
                  ...
                  <Group
                    ...
                    style={{ cursor: "pointer" }}
                  >
                    <Rect width={18} height={18} fill="white" stroke="#43a047" cornerRadius={6} opacity={0.85} />
                    <KonvaTextLabel x={2} y={2} text="✕" color="#43a047" size={16} noBg />
                  </Group>
                </Group>
              ))}
